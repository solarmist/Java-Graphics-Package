...
public class MaterialCell implements Serializable
{
	...
	public String mapKa;						/* (map_Ka) filename for ambient texture map */
	public String mapKd;						/* (map_Kd) filename for diffuse texture map */
	public String mapKs;						/* (map_Ks) filename for specular texture map */
	public String mapD;						/* (map_d ) filename for transparency texture map */
